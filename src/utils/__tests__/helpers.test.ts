...
describe('checkWeatherAlerts', () => {
  ...
  it('should generate heat alert with correct celsius unit symbol', () => {
    const weather = {
      ...mockWeatherBase,
      current: { ...mockWeatherBase.current, temperature_2m: 38 }
    };
  ...
  it('should generate heat alert with correct fahrenheit unit symbol and converted value', () => {
    const weather = {
      ...mockWeatherBase,
      current: { ...mockWeatherBase.current, temperature_2m: 38 }
    };
