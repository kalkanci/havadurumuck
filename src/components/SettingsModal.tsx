      ...
      <div className={`relative w-full max-w-sm bg-slate-950/95 backdrop-blur-xl border border-white/10 rounded-3xl p-6 shadow-2xl overflow-hidden ${isClosing ? 'animate-pop-out' : 'animate-pop-in'}`}>
        ...
        <div className="space-y-4">
            ...
            {onInstall && (
                <button
                    onClick={onInstall}
                    className="w-full bg-blue-600/20 p-4 rounded-2xl border border-blue-500/30 flex items-center justify-between group active:scale-[0.98] transition-all mt-4 hover:bg-blue-600/30"
                >
                    <div className="flex items-center gap-3">
