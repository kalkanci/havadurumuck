...
const DailyForecast: React.FC<DailyForecastProps> = ({ weather, unit, windSpeedUnit }) => {
  ...
  const renderDetailModal = () => {
      ...
      const wind = Math.round(convertWindSpeed(wind_speed_10m_max ? wind_speed_10m_max[index] : 0, windSpeedUnit));
