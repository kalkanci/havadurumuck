...
const App: React.FC = () => {
  const {
    location, weather, settings, favorites, loading, initialBoot,
    alerts, upcomingHolidays, cosmicData, deferredPrompt, error, gpsError, isOffline,
    setLocation, setSettings, addFavorite, removeFavorite, handleInstallClick,
    handleCurrentLocation, refreshAll, loadWeather, haptic
  } = useWeatherApp();
  ...
  const toastMarkup = isOffline ? <Toast message="İnternet bağlantısı yok, çevrimdışı mod" type="info" duration={0} /> : null;
