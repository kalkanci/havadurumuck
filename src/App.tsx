...
const App: React.FC = () => {
  const {
      location, setLocation, weather, loading, initialBoot, refreshing, setRefreshing,
      alerts, upcomingHolidays, cosmicData, settings, setSettings, favorites,
      addFavorite, removeFavorite, deferredPrompt, handleInstallClick, error, gpsError,
      handleCurrentLocation, loadWeather, loadHolidays, loadAstronomy, haptic
  } = useWeatherApp();
  ...
  }, [haptic, loadWeather, loadHolidays, loadAstronomy, setRefreshing]);
      ...
      <div className="relative z-10 flex flex-col min-h-screen px-4 pb-24 max-w-md mx-auto w-full transition-transform duration-300">
        ...
        {loading ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center">
            ...
            <p className="text-red-400 text-lg mb-2 font-bold">Hata Oluştu</p>
