...
const App: React.FC = () => {
  ...
  const [settings, setSettings] = useState<AppSettings>(() => {
      ...
      if (saved) {
          ...
          return { ...parsed, temperatureUnit: parsed.temperatureUnit || 'celsius', windSpeedUnit: parsed.windSpeedUnit || 'kmh' };
      }
  ...
  // Recalculate alerts when temperature unit changes without fetching data
  useEffect(() => {
    if (weather) {
