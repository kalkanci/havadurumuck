...
import { GeoLocation, AppSettings } from './types';
import { triggerHapticFeedback, calculateDistance } from './utils/helpers';
...
const App: React.FC = () => {
  ...
  const {
      ...
      refresh
  } = useWeatherApp({ hapticsEnabled: settings.hapticsEnabled });
  ...
  useEffect(() => {
    // Start the app flow handled by hook, but we need to handle PWA prompt here
