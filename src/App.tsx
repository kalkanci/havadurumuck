...
const App: React.FC = () => {
  const { state, actions, refs } = useWeatherApp();
  ...
  const {
      setLocation, loadWeather,
      setActiveTab, setIsFavoritesOpen, setIsSettingsOpen, setIsCalendarOpen,
      setSettings, handleCurrentLocation,
