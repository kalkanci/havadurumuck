        ...
        <div className="fixed inset-0 z-[600] flex items-center justify-center p-6">
            ...
            <div className={`relative w-full max-w-sm bg-gradient-to-b from-slate-900 to-slate-950 border border-white/10 rounded-[2rem] p-6 shadow-2xl overflow-hidden flex flex-col ${isDetailClosing ? 'animate-pop-out' : 'animate-pop-in'}`}>
                 ...
                 <div className="grid grid-cols-2 gap-3 mb-6 relative z-10">
                     {/* Temp Card */}
                     <div className="col-span-2 bg-gradient-to-br from-indigo-500/20 to-blue-600/10 p-5 rounded-3xl border border-indigo-500/20 flex items-center justify-between">
    ...
    <div className="w-full flex flex-col pb-24 animate-fade-in-up">
        ...
        <div className="mb-6 mt-2 px-2">
            <div className="flex items-center gap-3 mb-6">
                <div className="p-2 bg-indigo-500/20 rounded-xl text-indigo-300 ring-1 ring-indigo-500/30">
