  ...
  return (
    <div className="flex-1 flex flex-col w-full animate-pulse mt-10">
      ...
      <div className="flex space-x-4 mb-8 overflow-hidden">
        {[1, 2, 3, 4, 5].map((i) => (
          <div key={i} className="w-20 h-28 bg-slate-800/50 rounded-2xl flex-shrink-0"></div>
        ))}
      </div>

      {/* Card Skeletons */}
      <div className="w-full h-32 bg-slate-800/50 rounded-2xl mb-6"></div>
      <div className="w-full h-64 bg-slate-800/50 rounded-2xl mb-6"></div>
