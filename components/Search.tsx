          ...
          {results.map((loc) => (
            ...
            >
              <button
                ...
                className="w-full text-left px-4 py-3 hover:bg-white/10 focus:bg-white/10 outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500/50 transition-colors flex flex-col cursor-pointer"
              >
