          ...
          {results.map((loc) => (
            ...
            >
              <button
                ...
                className="w-full text-left px-4 py-3 hover:bg-white/10 focus:bg-white/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-blue-500 cursor-pointer flex flex-col transition-colors"
              >
