  ...
  return (
    <div ref={wrapperRef} className="relative w-full z-50">
      ...
      {isOpen && (loading || results.length > 0) && (
        <div className="absolute top-full left-0 right-0 mt-2 bg-slate-900/90 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl max-h-60 overflow-y-auto no-scrollbar overflow-hidden z-[60]">
          {loading ? (
              ...
              {results.map((loc) => (
                ...
                >
                  <button
                    ...
                    className="w-full text-left px-4 py-3 hover:bg-white/10 cursor-pointer flex flex-col transition-colors focus:bg-white/10 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500/50"
                  >
