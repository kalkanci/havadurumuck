  ...
  const renderModal = () => {
    ...
    return createPortal(
      <div className="fixed inset-0 z-[500] flex items-center justify-center p-6">
         ...
         <div className={`relative w-full max-w-lg bg-slate-900 border border-white/10 rounded-[2rem] overflow-hidden shadow-2xl flex flex-col max-h-[85vh] ${isClosing ? 'animate-pop-out' : 'animate-pop-in'}`}>
