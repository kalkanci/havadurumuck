...
const AdviceCard: React.FC<AdviceCardProps> = ({ weather, cityName }) => {
                                ...
                                {data.activities.map((act, idx) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-4 relative z-10">
                                            <div className="p-2.5 bg-slate-900 rounded-xl shadow-inner text-indigo-400 group-hover:text-indigo-300 transition-colors">
                                                <Zap size={20} />
                                            </div>
  ...
  return (
    ...
    >
      ...
      {/* Subtle CTA */}
      <div className="mt-4 flex items-center gap-2 text-[10px] font-bold text-slate-400 uppercase tracking-wider group-hover:text-indigo-300 transition-colors">
